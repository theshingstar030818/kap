...
class PlayBar extends React.Component {
  ...
  render() {
    const {currentTime = 0, duration, startTime, endTime, hover, pause, play, src} = this.props;
      ...
      <div className="container" onMouseUp={this.seek} onMouseMove={this.updatePreview}>
        <div className={className}>
          <div className="progress-bar">
            <progress max={total} value={current} ref={this.progress}/>
            <div className="preview"><Preview src={src} time={previewTime} duration={previewDuration} hidePreview={resizing}/></div>
            <input
              type="range"
              className="slider
              start"
